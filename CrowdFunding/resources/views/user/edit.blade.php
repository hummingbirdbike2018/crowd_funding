...
<div class= "container">
	<div class="edit_user row">
		...
		@foreach($users as $user)
			...
			<input class="btn btn-primary rounded-0 float-right" type="submit" value="基本情報を更新" method="POST">
		</div>
	<span class="border-right"></span>
		<div class= "edit_user is_address col col-md-3 mx-auto">
			...
			<input id="building" class="form-control rounded-0 mb-4" value="{{ $user->building }}">
		@endforeach
			<input class="btn btn-primary rounded-0 float-right" type="submit" value="配送先情報を更新" method="POST">
		</div>
	</div>
</div>
<div class="container">
	...
	<span class="border-right"></span>
		<div class="edit_user is_disable col col-md-3 mx-auto" style="width: 810px;">
			<h5 class="mt-5 mb-5">退会</h5>
				...
				<a class="btn btn-secondary rounded-0 float-right" href="#" role="button">退会</a>
		</div>
	</div>
</div>
